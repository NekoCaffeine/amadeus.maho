...
@Transformer
public class AugmentVisitorTransformer implements ClassTransformer.Limited {
    ...
    @Override
    public Set<String> targets() = Set.of("com.sun.tools.javac.code.Lint$AugmentVisitor");
